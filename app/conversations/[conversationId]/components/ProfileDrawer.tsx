...
const ProfileDrawer: FC<IProfileDrawer> = ({ data, isOpen, onClose }) => {
      ...
      <Dialog as={"div"} className={"relative z-50"} onClose={onClose}>
        ...
        <div className={"fixed inset-0 overflow-hidden"}>
          <div className={"absolute inset-0 overflow-hidden"}>
            <div
              className={
                "pointer-events-none fixed inset-y-0 flex right-0 max-w-full pl-10"
              }
            >
              <Transition.Child
                as={Fragment}
              ...
              >
                ...
                >
                  <div
                    className={
                      "flex flex-col h-full overflow-y-scroll bg-white py-6 shadow-xl"
                    }
                  >
